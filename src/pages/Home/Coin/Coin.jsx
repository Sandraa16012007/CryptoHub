...
const Coin = () => {
  ...
  const calculateSentiment = () => {
    if (!coindata?.market_data?.price_change_percentage_24h) return { text: "Neutral", percentage: 50, isPositive: null };
        ...
        <div className="coin-header">
          ...
          <div className="coin-name-section">
            ...
            <div className="coin-price-badge">
              ...
              <span className={`price-change ${coindata.market_data.price_change_percentage_24h >= 0 ? 'positive' : 'negative'}`}>
            ...
            <div className="sentiment-card">
              <div className="sentiment-bar-container">
                ...
                <div className="sentiment-bar">
                  ...
                  >
                    <span className="sentiment-value">{sentiment.percentage.toFixed(0)}%</span>
                  </div>
                  <div className="sentiment-bar-fill bullish-fill" style={{ width: `${sentiment.percentage}%` }}></div>
                </div>
              </div>
              <div className="sentiment-status">
                <span className={sentiment.isPositive ? 'status-bullish' : 'status-bearish'}>
                  {sentiment.text}
                </span>
                <span className="sentiment-subtext">Based on 24h price movement</span>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="metrics-grid">
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <span className="metric-value rank-badge">#{coindata.market_cap_rank}</span>
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <div className="metric-content">
              ...
              <span className="metric-value">
                {coindata.market_data.max_supply?.toLocaleString() || 'Unlimited'}
                {coindata.market_data.max_supply && <span className="supply-symbol"> {coindata.symbol?.toUpperCase()}</span>}
              </span>
            </div>
          </div>
        </div>
