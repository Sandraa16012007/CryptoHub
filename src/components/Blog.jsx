...
export default function Blog() {
  ...
  return (
    <div className="blog-page glassnode-style bg-[var(--bg-deep)] text-[var(--text-main)]">
          ...
          >
            <div className="hero-badge">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <circle cx="8" cy="8" r="7" stroke="var(--primary-color)" strokeWidth="2" />
                <path d="M5 8L7 10L11 6" stroke="var(--primary-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
